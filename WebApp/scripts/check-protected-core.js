...
const expected = {
  // iOS port authoritative source baseline:
  // q-app-an/main@cc2d1c2389a3de4d2cb4dbb6329da868dd1e6247.
  // Only the guard manifest is aligned here; no protected engine file is modified.
